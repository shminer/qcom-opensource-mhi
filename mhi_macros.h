...
#define MHI_LINK_STABILITY_WAIT_MS 10000
#define MHI_MAX_LINK_RETRIES	9
#define MHI_ENABLE_BHI		1
#define MHI_DEBUG
#define MHI_VERSION		0x01000000
#define ALIGNMENT_OFFSET	0xFFF	/* 4K Allignment */
#define NR_OF_CMD_RINGS		1
#define EV_EL_PER_RING		129
#define CMD_EL_PER_RING		4
...
#define MHI_WORK_Q_MAX_SIZE	100
...
#define MHI_PCIE_MMIO_MSI_MASK_REGISTER 0x20
...
#define IS_HARDWARE_CHANNEL(_CHAN_NR) (((MHI_CLIENT_CHANNEL)(_CHAN_NR) > \
...
#define MHI_TX_TRB_GET_LEN(_FIELD, _PKT)				 \
	(((_PKT)->data_tx_pkt).buf_len & (((MHI_##_FIELD ## __MASK) << MHI_##_FIELD ## __SHIFT))); \
...
#define MHI_TRB_READ_INFO(_FIELD,_PKT)					 \
	((((_PKT)->type).info >> MHI_##_FIELD ## __SHIFT) & MHI_##_FIELD ## __MASK)
...
{									\
	...
	mhi_log(MHI_MSG_VERBOSE,"db.set addr: 0x%llX offset 0x%x val:0x%llX\n",\
